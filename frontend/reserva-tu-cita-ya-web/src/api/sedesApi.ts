...
export const listSedes = (organizationId: string, filters: { busqueda?: string; estado?: EstadoFiltro }, signal?: AbortSignal) =>
  apiRequest<Sede[]>(`/api/organizaciones/${organizationId}/sedes${queryString(filters)}`, { signal })
