...
export interface MetodoPagoOpcion { id: string; nombre: string }
...
export interface ReservaPorDia { fecha: string; cantidad: number }
export interface ReservasPorEstado { estado: EstadoReserva; cantidad: number }
export interface IngresoPorDia { fecha: string; ingresosBrutos: number; reembolsos: number; ingresosNetos: number }
export interface TopServicioDashboard { servicioId: string; nombre: string; cantidadReservas: number; porcentajeSobreTotal: number }
...
export interface DashboardFiltros { fechaDesde: string; fechaHasta: string; sedeId?: string; organizacionId?: string }
